            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="adminSortCourseOfferingsBuilding.php"><font color="#141E30">Course Offerings - SORT BY BUILDING</font></a>
                    </div>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card card-chart">
                            <div class="card-header">
                                <i class="now-ui-icons design_palette" style="font-size: 2.50em;"></i>
                                <h4 class="card-title">Andrew Gonzalez Hall</h4>
                                <br>
                            </div>
                            <div class="card-body">
                                <center>
                                    <a href="adminSortCourseOfferingsBuilding1.php">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-chart">
                            <div class="card-header">
                                <i class="now-ui-icons tech_laptop" style="font-size: 2.50em;"></i>
                                <h4 class="card-title">Gokongwei Hall</h4>
                                <br>
                            </div>
                            <div class="card-body">
                                <center>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-chart">
                            <div class="card-header">
                                <i class="now-ui-icons business_bulb-63" style="font-size: 2.50em;"></i>
                                <h4 class="card-title">St. La Salle Hall</h4>
                                <br>
                            </div>
                            <div class="card-body">
                                <center>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card card-chart">
                            <div class="card-header">
                                <i class="now-ui-icons education_atom" style="font-size: 2.50em;"></i>
                                <h4 class="card-title">St. Joseph Hall</h4>
                                <br>
                            </div>
                            <div class="card-body">
                                <center>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-chart">
                            <div class="card-header">
                                <i class="now-ui-icons ui-2_settings-90" style="font-size: 2.50em;"></i>
                                <h4 class="card-title">Velasco Hall</h4>
                                <br>
                            </div>
                            <div class="card-body">
                                <center>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-chart">
                            <div class="card-header">
                                <i class="now-ui-icons business_briefcase-24" style="font-size: 2.50em;"></i>
                                <h4 class="card-title">Yuchengco Hall</h4>
                                <br>
                            </div>
                            <div class="card-body">
                                <center>
                ...
                <a href="adminCourseOfferings.php" style="color:#FFF"><button type="button" class="btn btn-default">BACK TO COURSE OFFERINGS</button></a>
            </div>
            <footer class="footer">
                <div class="container-fluid">
                    <div class="copyright">
