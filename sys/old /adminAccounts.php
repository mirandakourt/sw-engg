            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-chart">
                            <div class="card-header">
                                <i class="now-ui-icons ui-1_lock-circle-open" style="font-size: 2.50em;"></i>
                                <h4 class="card-title">Activated accounts</h4>
                                <br>
                                <p>View details of all currently activated accounts</p>
                            </div>
                            <div class="card-body">
                                <center>
                                    <a href="adminActivatedAccounts.php">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-chart">
                            <div class="card-header">
                                <i class="now-ui-icons design_scissors" style="font-size: 2.50em;"></i>
                                <h4 class="card-title">Deactivated accounts</h4>
                                <br>
                                <p>View details of all deactivated accounts</p>
                            </div>
                            <div class="card-body">
                                <center>
                                    <a href="adminDeactivatedAccounts.php">
