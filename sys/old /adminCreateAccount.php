            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="adminAccounts.php"><font color="#141E30">Accounts - Create Account</font></a>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 pr-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Contact" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-6 pl-1">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 pr-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Admin or Tracker" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-4 pr-1">
                                            <div class="form-group">
                                    ...
                                    <br>
                                    Upload Account Image:&nbsp;&nbsp;<input type="file" name="accountImage" accept="image/*">
                                    <br><br>
                                        ...
                                        <button type="button" class="btn btn-warning" style="float:right">CREATE ACCOUNT</button>
                                </form>
                            </div>
                        </div>
                    </div>
