            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="adminActivatedAccounts.php"><font color="#141E30">Accounts - Activated Accounts</font></a>
                    </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="submit" class="btn btn-danger btn-fill" value="DEACTIVATE" />
                                                </td>    
                                            </tr>
                                            <tr>
                                                <td>
                                                    <a href="adminActivatedAccountID.php" style="color:#01703D">971111116</a>
                                                </td>
                                                <td>
                                                    Reinhart, L.
                                                </td>
