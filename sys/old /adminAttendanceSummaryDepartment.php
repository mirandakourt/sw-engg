            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="adminAttendanceSummaryDepartment.php"><font color="#141E30">Attendance Summary - By Department</font></a>
                    </div>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card card-chart">
                            <div class="card-header">
                                ...
                                <h4 class="card-title">CCS</h4>
                                <br>
                                <p>College of Computer Studies</p>
                            </div>
                            <div class="card-body">
                                <center>
                                    <a href="adminAttendanceSummaryDepartmentCCS.php">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-chart">
                            <div class="card-header">
                                <i class="now-ui-icons education_hat" style="font-size: 2.50em;"></i>
                                <h4 class="card-title">CED</h4>
                                <br>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card card-chart">
                            <div class="card-header">
                                <i class="now-ui-icons business_chart-bar-32" style="font-size: 2.50em;"></i>
                                <h4 class="card-title">SOE</h4>
                                <br>
