            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="adminAttendanceSummaryFacultyID.php"><font color="#141E30">Attendance Summary - Stark, T.</font></a>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-user">
                                    <br><br><br><br>
                                <div class="author">
                                    <img class="avatar border-gray" src="../assets/img/rdj.jpg" alt="...">
                                    <h5 class="title" style="color:#01703D">STARK, T.</h5>
                            ...
                            <div class="card-body">
                                ...
                                <a href="adminAttendanceSummaryFaculty.php" style="color:#FFF"><button type="button" class="btn btn-default" style="float:left">BACK TO FACULTY ATTENDANCE</button></a>
                                <button type="button" class="btn btn-primary" style="float:right">EDIT SUMMARY</button>
                                <br><br><br>
                                <a href="#" style="color:#FFF"><button type="button" class="btn btn-primary" style="float:right">SEND E-MAIL</button></a>
                                <br><br><br>
                                <a href="#" style="color:#FFF"><button type="button" class="btn btn-primary" style="float:right">SAVE AS PDF</button></a>
                            </div>
                        </div>
                    </div>
                </div>
