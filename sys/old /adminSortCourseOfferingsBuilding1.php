            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="adminSortCourseOfferingsBuilding1.php"><font color="#141E30">Course Offerings - Andrew Gonzalez Hall</font></a>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="adminSortCourseOfferingsBuilding.php" style="color:#FFF"><button type="button" class="btn btn-default" style="float:left">BACK TO BUILDINGS</button></a>
                            </div>
                        </div>
                    </div>
                </div>
