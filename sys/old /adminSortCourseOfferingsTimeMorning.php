            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="adminSortCourseOfferingsTimeMorning.php"><font color="#141E30">Course Offerings - Morning classes</font></a>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="adminSortCourseOfferingsTime.php" style="color:#FFF"><button type="button" class="btn btn-default" style="float:left">BACK TO TIMESLOTS</button></a>
                            </div>
                        </div>
                    </div>
                </div>
