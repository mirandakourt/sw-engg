            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="adminDeactivatedAccounts.php"><font color="#141E30">Accounts - Deactivated Accounts</font></a>
                    </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="submit" class="btn btn-success btn-fill" value="REACTIVATE" />
                                                </td>    
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="adminDeactivatedAccountID.php" style="color:#01703D">971111119</a>
                                                </td>
                                                <td>
                                                    Mendes, C.
                                                </td>
