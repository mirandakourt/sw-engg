            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="adminAttendanceSummary.php"><font color="#141E30">Attendance Summary</font></a>
                    </div>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card card-chart">
                            <div class="card-header">
                                <i class="now-ui-icons business_bank" style="font-size: 2.50em;"></i>
                                <h4 class="card-title">By college</h4>
                                <br>
                                <p>View attendance summary according to college</p>
                            </div>
                            <div class="card-body">
                                <center>
                                    <a href="adminAttendanceSummaryCollege.php">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-chart">
                            <div class="card-header">
                                ...
                                <br>
                                <p>View attendance summary according to department</p>
                            </div>
                            <div class="card-body">
                                <center>
                                    <a href="adminAttendanceSummaryDepartment.php">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-chart">
                            <div class="card-header">
                                <i class="now-ui-icons users_single-02" style="font-size: 2.50em;"></i>
                                <h4 class="card-title">By faculty</h4>
                                <br>
                                <p>View attendance summary according to faculty</p>
                            </div>
                            <div class="card-body">
                                <center>
                                    <a href="adminAttendanceSummaryFaculty.php">
