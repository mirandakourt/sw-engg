            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="adminCourseOfferings.php"><font color="#141E30">Course Offerings</font></a>
                    </div>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        <div class="card card-chart">
                            <div class="card-header">
                                <i class="now-ui-icons design-2_ruler-pencil" style="font-size: 2.50em;"></i>
                                <h4 class="card-title">Edit list</h4>
                                <br>
                                <p>View and edit list of course offerings for current term</p>
                            </div>
                            <div class="card-body">
                                <center>
                                    <a href="adminEditCourseOfferings.php">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="card card-chart">
                            <div class="card-header">
                                <i class="now-ui-icons files_box" style="font-size: 2.50em;"></i>
                                <h4 class="card-title">Sort by</h4>
                                <br>
                                <p>Select how to view and sort list of course offerings </p>
                            </div>
                            <div class="card-body">
                                <center>
                                    <a href="adminSortCourseOfferingsBuilding.php">
                                        <button type="button" class="btn btn-warning">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;BUILDING&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
                                    </a>
                                    <a href="adminSortCourseOfferingsTracker.php">
                                        <button type="button" class="btn btn-danger">TRACKER</button>
                                    </a>
                                    <br>
                                    <a href="adminSortCourseOfferingsCode.php">
                                        <button type="button" class="btn btn-primary">COURSE CODE</button>
                                    </a>
                                    <a href="adminSortCourseOfferingsTime.php">
                                        <button type="button" class="btn btn-success">TIMESLOT</button>
                                    </a>
                                </center>            
                            </div>
                        </div>
