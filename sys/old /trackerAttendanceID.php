                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="author">
                                    ...
                                    <h5 class="title" style="color:#01703D">ROGERS, S.</h5>
                            ...
                            <div class="card-body">
                                ...
                                <a href="trackerAttendance.php" style="color:#FFF"><button type="button" class="btn btn-default" style="float:left">BACK TO ALL ATTENDANCE</button></a>
                                <button type="button" class="btn btn-primary" style="float:right">EDIT THIS ATTENDANCE</button>
                            </div>
                        </div>
                    </div>
                </div>
