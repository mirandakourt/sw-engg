                                    ...
                                    <div class="row">
                                        <div class="col-md-6 pr-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="First Name" value="Emily">
                                            </div>
                                        </div>
                                        <div class="col-md-6 pl-1">
                                            <div class="form-group">
                                                <label>Last Name</label>
                                                <input type="text" class="form-control" placeholder="Last Name" value="Prentiss">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 pr-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Contact" value="(+63) 917 810 7445">
                                            </div>
                                        </div>
                                        <div class="col-md-6 pl-1">
                                            <div class="form-group">
                                                <label>E-mail</label>
                                                <input type="text" class="form-control" placeholder="E-mail" value="emily.prentiss@dlsu.edu.ph">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 pr-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Username" value="emily_prentiss">
                                            </div>
                                        </div>
                                        <div class="col-md-6 pl-1">
                                            <div class="form-group">
                                                <label>Password</label>
                                                <input type="password" class="form-control" placeholder="Password" value="blackbird">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                        ...
                        <div class="card card-user">
                           <br><br><br><br>
                            <div class="card-body">
                                <div class="author">
                                    <a href="#">
                                        <img class="avatar border-gray" src="../assets/img/emily.jpg" alt="...">
                                        <h5 class="title" style="color:#01703D">Emily Prentiss</h5>
                                        <br>
                                    </a>
