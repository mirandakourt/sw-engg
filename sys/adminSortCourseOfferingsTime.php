            ...
            <nav class="navbar navbar-expand-lg navbar-transparent  navbar-absolute bg-primary fixed-top">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="adminSortCourseOfferingsTime.php"><font color="#141E30">Course Offerings - Sort by timeslot</font></a>
                    </div>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="card card-chart">
                            <div class="card-header">
                                <i class="now-ui-icons ui-2_time-alarm" style="font-size: 2.50em;"></i>
                                <h4 class="card-title">Morning classes</h4>
                                <br>
                            </div>
                            <div class="card-body">
                                <center>
                                    <a href="adminSortCourseOfferingsTimeMorning.php">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-chart">
                            <div class="card-header">
                                <i class="now-ui-icons ui-1_bell-53" style="font-size: 2.50em;"></i>
                                <h4 class="card-title">Afternoon classes</h4>
                                <br>
                            </div>
                            <div class="card-body">
                                <center>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-chart">
                            <div class="card-header">
                                <i class="now-ui-icons tech_watch-time" style="font-size: 2.50em;"></i>
                                <h4 class="card-title">Evening classes</h4>
                                <br>
                            </div>
                            <div class="card-body">
                                <center>
