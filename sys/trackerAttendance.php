                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navigation">
                      ...
                      <ul class="navbar-nav">
                            <li class="nav-item dropdown">
                                <a class="nav-link" href="../sys/loginPage.php" id="navbarDropdownMenuLink" aria-haspopup="true" aria-expanded="false">
                                    Logout
    ...
    die("Connection failed: " . mysqli_connect_error());
        ...
        if ( mysqli_num_rows($result) > 0) {    
            ...
            '<table width="80%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
                <tr>
                <th width="10%" border = "1"><div align ="center"><b>Date</div></b></td>
                <th width="10%" border = "1"><div align ="center"><b>Faculty First Name</div></b></td>
                <th width="10%" border = "1"><div align ="center"><b>Faculty Last Name</div></b></td>
            ...
            while ($row = $result ->fetch_assoc()) {
                echo "<tr><td align='center'>".$row["c_day"]."</td>
                        <td align='center'>".$row["f_firstname"]."</td>
