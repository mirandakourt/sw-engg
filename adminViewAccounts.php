...
<body class="">
    <div class="wrapper ">
        ...
        <div class="main-panel">
			...
			$rowID=1;
				foreach($result as $user){
					...
					echo '</td>';
					echo '<td>';
					echo "<a href='adminViewAccounts.php?rowID=".$rowID."'><button value = ".$rowID." name='activate'
					".(($user['u_status']=='Activated')? "disabled":"").">
						Activate</button></a>";
					echo "<a href='adminViewAccounts.php?rowID=".$rowID."'><button value = ".$rowID." name='deactivate'"
		...
		?>
                                        ...
                                        <a href="adminCreateAccount.php" style="color:#FFF"><button type="button" class="btn btn-warning" style="float:left;background-color:#2d8911">CREATE ACCOUNT</button></a>
                            </div>
                        </div>
                    </div>
                </div>
