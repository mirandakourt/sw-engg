    ...
    if(isset ($_POST["u_username"]) && isset ($_POST["u_password"])){
        ...
        $u_password = $_POST["u_password"];
         ...
         if (mysqli_num_rows($query)==1){
            header('Location: '. "../sys/adminAttendanceSummary.php"); //admin page
            $_SESSION["u_username"]=$u_username;
            $_SESSION['home'] = "../sys/adminAttendanceSummary.php";
            $_SESSION['u_type']="1";
         }else if (mysqli_num_rows($query2)==1){
            header('Location: '. "../sys/trackerAttendance.php"); //tracker page
            $_SESSION["u_username"]=$u_username;
            $_SESSION['home'] = "../sys/trackerAttendance.php";
            $_SESSION['u_type']="2";    
         }else{
